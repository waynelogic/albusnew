...
class CategoryModelHandler
{
    ...
    protected function addProductPropertyField($obItem)
    {
        ...
        $obItem->addDynamicMethod('getProductFilterPropertyAttribute', function () use ($obItem) {
    ...
    protected function addOfferPropertyField($obItem)
    {
        ...
        $obItem->addDynamicMethod('getOfferFilterPropertyAttribute', function () use ($obItem) {
