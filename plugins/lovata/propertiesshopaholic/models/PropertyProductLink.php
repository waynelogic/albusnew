 ...
 */
class PropertyProductLink extends Pivot
{
    public $table = 'lovata_properties_shopaholic_set_product_link';
    ...
    {
        $arGroupList = (array) Group::orderBy('name', 'ASC')->pluck('name', 'id')->all();
